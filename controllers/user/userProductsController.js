...
const getZodiacProducts = async (req, res) => {
  try {
    ...
    if (sort === "price-low") products.sort((a,b)=>a.effectivePrice-b.effectivePrice);
    else if (sort === "price-high") products.sort((a,b)=>b.effectivePrice-a.effectivePrice);
    else if (sort === "name") products.sort((a,b)=>a.productName.localeCompare(b.productName));
    else products.sort((a,b)=>(b.createdAt||b._id)-(a.createdAt||a._id));
